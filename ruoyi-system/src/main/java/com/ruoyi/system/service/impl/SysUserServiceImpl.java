...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public void saveEmployeeForCenter(SysUser sysUser){
        ...
        if (sysUserCenter == null) {//无数据则新增
            ...
            BeanUtils.copyProperties(sysUser, sysUserCenter);
            sysUserCenter.setUserId(null);
            sysUserCenter.setPvcFlag(0);
            sysUserCenter.setPpFlag(0);
            sysUserCenter.setAeFlag(0);
            sysUserCenter.setSapFlag(0);
            sysUserCenter.setEvaFlag(0);
            sysUserCenter.setMaFlag(0);
            sysUserCenter.setPzFlag(0);
            userMapper.insertUser(sysUserCenter);
    ...
    @Override
    public List<SysUser> selectUserUnSync() {
        return userMapper.selectUserUnSync();
    }

    @Override
    public void updateSyncedUser(String idCard, TaisuFactory factory) {
        userMapper.updateSyncedUser(idCard,factory);
    }
